        ...
        <div class="row">
            <div class="col-lg-12 d-flex">
                <div class="mr-auto d-flex">
                    ...
                    <div class="inline-block ml-5 align-self-center pt-2 date">
                        <h3 class="text-left author">{{$article->created_at->format('d F Y')}}</h3>
                    </div> 
                </div>
                @if(isset($article->thumbnail)) 
                <div class="d-flex align-items-center justify-content-center mr-5 ml-5 pb-3">
                    <a href="{{$article->thumbnail->realPath}}" target="_blank"><i class="fa fa-file-o"></i> Download document here</a>
                </div>
                @endif
            ...
            <div class="col-lg-12 mt-5">
                <div class="mx-auto mb-5 mb-lg-0 mb-lg-3">
                    <h1 class="title2 text-left text-dark-4">{{$article->title}}</h1>
                ...
                <div class="row pl-5 pr-5">
                    <div class="col-lg-4 col-sm-6 col-12 mt-4">
                        ...
                        <div class="card-pro-text">
                            <h4>Sky diving in Pangong Lake</h4>   
                        </div>     
                    </div>
                    <div class="col-lg-4 col-sm-6 col-12 mt-4">
                        <div class="card-pro"></div>     
