        ...
        <div class="row">
            <div class="col-lg-12 d-flex">
                <div class="mr-auto d-flex">
                    ...
                    <div class="inline-block ml-5 align-self-center pt-2 date">
                        <h3 class="text-left author">{{$news->created_at->format('d F Y')}}</h3>
                    </div> 
                </div>
                @if(isset($news->thumbnail)) 
                <div class="d-flex align-items-center justify-content-center mr-5 ml-5 pb-3">
                    <a href="{{$news->thumbnail->realPath}}" target="_blank"><i class="fa fa-file-o"></i> Download document here</a>
                </div>
                @endif
            ...
            <div class="col-lg-12 mt-5">
                <div class="mx-auto mb-5 mb-lg-0 mb-lg-3">
                    <h1 class="title2 text-left text-dark-4">{{$news->title}}</h1>
