...
class Roadtoladakh extends Model
{
    protected $table = 'roadtoladakh';
    ...
    /**
     * Scope a query to search roadtoladakh
     */
    ...
    /**
     * Scope a query to order roadtoladakh by latest posted
     */
    ...
    /**
     * Scope a query to only include roadtoladakh posted last month.
     */
    ...
    /**
     * Scope a query to only include roadtoladakh posted last week.
     */
    ...
    public function images() {
        return $this->belongsToMany('App\Models\Document', 'roadtoladakh_images', 'roadtoladakh_id', 'image_id');
    }
}
