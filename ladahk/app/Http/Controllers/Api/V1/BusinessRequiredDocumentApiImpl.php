...
class BusinessRequiredDocumentApiImpl extends Controller
{
    /**
     * Constructor
     */
    ...
    public function allBusinessRequiredDocuments()
    {
        try {
            $input = Request::all();
              ...
              $query = new BusinessRequiredDocument();
    ...
    public function deleteBusinessRequiredDocument($id)
    {
        try {
            ...
            if( $decodedToken ) {
                ...
                $document = BusinessRequiredDocument::find($id);
    ...
    {
        try {
            $query = BusinessRequiredDocument::where('id', $id)->with('thumbnail', 'banner', 'images');
