...
class SliderApiImpl extends Controller
{
    /**
     * Constructor
     */
    ...
    public function allSliders()
    {
        try {
              $input = Request::all();
                ...
                $sliders = $query->with('image')->orderBy($sortBy, $sortOrder)->skip($skip)->take($limit)->get();
    ...
    {
        try {
            $query = Slider::where('id', $id)->with('image');
