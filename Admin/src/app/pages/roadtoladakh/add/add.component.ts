...
export class AddComponent implements OnInit {
  ...
  onAllDone() {
    ...
    console.log('data this.form.value', this.form.value);
    console.log('data this.form', this.data);

    const roadtoladakh = new Roadtoladakh({
