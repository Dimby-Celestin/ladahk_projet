...
/* harmony import */ var _app_models_news_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @app-models/news.model */ "./src/app/shared/models/news.model.ts");
...
/* harmony import */ var _app_services_news_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @app-services/news.service */ "./src/app/shared/services/news.service.ts");
...
function AddComponent_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function AddComponent_div_10_Template_form_ngSubmit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r78); const ctx_r77 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r77.submit(); });
...
class AddComponent {
    constructor(_categorieService, _newsService, _formHelperService, _fb, _toasterService, _route, _utilsService) {
    ...
    loadData() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this.id !== 'new') {
                this.data = yield this._newsService.load(this.id).toPromise();
            }
            else {
    ...
    submit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const news = new _app_models_news_model__WEBPACK_IMPORTED_MODULE_3__["News"](Object.assign(Object.assign({}, this.form.value), { slug: this._utilsService.slugify(this.form.value.title) }));
            if (this.data.id) {
...
/* harmony import */ var _app_services_news_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @app-services/news.service */ "./src/app/shared/services/news.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _app_providers_utils_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @app-providers/utils.service */ "./src/app/shared/providers/utils.service.ts");
...
const _c0 = function (a1) { return ["/news/add", a1]; };
...
function ListComponent_li_41_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ListComponent_li_41_a_1_Template_a_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r93); const customPage_r88 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit; _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); const _r82 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](32); return _r82.setCurrent(customPage_r88.value); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const customPage_r88 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();
    const _r82 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](32);
...
function ListComponent_li_41_Template(rf, ctx) { if (rf & 1) {
    ...
    const customPage_r88 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();
    const _r82 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](32);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
...
class ListComponent extends app_core_pages_page_with_listing__WEBPACK_IMPORTED_MODULE_3__["PageWithListing"] {
    ...
    loadData(pageNumber, pageSize) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                this.rows = yield this._newsService.list(pageNumber, pageSize, queryString).toPromise();
                this.isLoading = false;
    ...
    delete(item) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                yield this._utils.confirm('Are you really want to delete the news?');
                this.isLoading = true;
                yield this._newsService.delete(item).toPromise();
                yield this.loadData();
                this.isLoading = false;
            }
            catch (e) {
...
ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ListComponent, selectors: [["app-list"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 50, vars: 11, consts: [["id", "admin", 1, "main-content", "container"], [1, "container-fluid"], [1, "row"], [1, "col-md-12"], [1, "title"], [1, "title-2"], [1, "btn", "btn-warning", "ml-4", 3, "routerLink"], [1, "col-md-12", "mt-2"], [1, "col-md-12", "d-flex", "mt-4"], [1, "col-xs-12", "col-md-10", "content", "table-responsive", "mt-4"], [1, "table", "table-hover"], [1, "text-left", "border-top-0"], [1, "text-left", "border-top-0", 2, "width", "200px"], ["class", "pt-3", 4, "ngIf"], [1, "col-lg-12", "pb-4", "mt-5", "mb-4", "footer-pager", "text-center"], [1, "col", "text-right"], ["id", "page", 3, "pageChange"], ["p", "paginationApi"], [1, "mx-auto"], [1, "pagination", "mx-auto"], [1, "page-item"], [1, "page-link", "prev", 3, "click"], ["aria-hidden", "true"], [1, "sr-only"], ["class", "page-item", 4, "ngFor", "ngForOf"], [1, "page-link", "next", 3, "click"], [1, "text-center"], [1, "pt-3"], [4, "ngFor", "ngForOf"], [1, "text-left"], [1, "text-left", 3, "innerHTML"], [1, "td-actions", "text-right"], [1, "btn", "btn", "btn-outline-dark", "btn-link", "btn-xs", 3, "routerLink"], [1, "btn", "btn", "btn-outline-danger", "text-danger", "btn-link", "btn-xs", 3, "click"], ["class", "page-link", 3, "active", "click", 4, "ngIf"], ["class", "page-link active", 4, "ngIf"], [1, "page-link", 3, "click"], [1, "page-link", "active"]], template: function ListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ListComponent_Template_a_click_36_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r96); const _r82 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](32); return !_r82.isFirstPage() && _r82.previous(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ListComponent_Template_a_click_43_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r96); const _r82 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](32); return !_r82.isLastPage() && _r82.next(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ListComponent, [{
    ...
    }], function () { return [{ type: _app_services_news_service__WEBPACK_IMPORTED_MODULE_4__["NewsService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: _app_providers_utils_service__WEBPACK_IMPORTED_MODULE_6__["UtilsService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] }]; }, null); })();
...
/* harmony import */ var _list_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list/list.component */ "./src/app/pages/news/list/list.component.ts");
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./detail/detail.component */ "./src/app/pages/news/detail/detail.component.ts");
/* harmony import */ var _add_add_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./add/add.component */ "./src/app/pages/news/add/add.component.ts");
...
/* harmony import */ var _list_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./list/list.component */ "./src/app/pages/news/list/list.component.ts");
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./detail/detail.component */ "./src/app/pages/news/detail/detail.component.ts");
...
/* harmony import */ var _add_add_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add/add.component */ "./src/app/pages/news/add/add.component.ts");
...
/* harmony import */ var _news_routing_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./news-routing.module */ "./src/app/pages/news/news-routing.module.ts");
...
NewsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function NewsModule_Factory(t) { return new (t || NewsModule)(); }, providers: [
        { provide: _angular_core__WEBPACK_IMPORTED_MODULE_0__["LOCALE_ID"], useValue: 'fr-FR' }
            ...
            _news_routing_module__WEBPACK_IMPORTED_MODULE_12__["NewsRoutingModule"],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NewsModule, { declarations: [_list_list_component__WEBPACK_IMPORTED_MODULE_5__["ListComponent"],
...
class News extends _base_model__WEBPACK_IMPORTED_MODULE_0__["BaseModel"] {
    constructor(arg) {
        super(arg);
        if (arg) {
...
/* harmony import */ var _app_models_news_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @app-models/news.model */ "./src/app/shared/models/news.model.ts");
...
class NewsService extends _base_service__WEBPACK_IMPORTED_MODULE_1__["BaseService"] {
    constructor(_httpService) {
        super(_httpService, _app_models_news_model__WEBPACK_IMPORTED_MODULE_2__["News"], 'news', 'news');
        this._httpService = _httpService;
    }
}
NewsService.ɵfac = function NewsService_Factory(t) { return new (t || NewsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_providers_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"])); };
